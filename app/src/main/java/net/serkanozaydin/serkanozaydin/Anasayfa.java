...
public class Anasayfa extends Fragment {
    ...
    public ImageButton Anasayfa,Python,BenKimim, Projelerim, WebUgra, Yeteneklerim, Linux, Android, RaspberryPi, KisiselDeneyimlerim, Facebook, Twitter, Github, Instagram, Android_Sosyal, Youtube;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Python= (ImageButton) root.findViewById(R.id.btnPython);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    case MotionEvent.ACTION_UP: {
                        ...
                        transaction.commit();
                        Model model = new Model("https://www.serkanozaydin.net/python/");
